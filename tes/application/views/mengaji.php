...
<head>
	...
	<link rel="stylesheet" type="text/css" href=<?=DOMAIN."css/psb.css"?>>
	<link rel="stylesheet" type="text/css" href=<?=DOMAIN."css/csba.css"?>>
...
<body>
        ...
        <div id='navbar' class='navbar-collapse collapse navbar-right'>
          <ul class='nav navbar-nav'>
           <li class='dropdown'>
              ...
              <ul class='dropdown-menu aa notif' style="min-width:400px">
                <div class='list-group'>
                	<?php foreach ($notif->result() as $lnotif) {
                		?>
                		<a href="<?php echo base_url()."index.php/mengaji/lihatnotif/".$lnotif->id_notif; ?>" class="list-group-item">
            ...
            <li><a href='<?php echo base_url()."index.php/mengaji/logout"; ?>'>logout</a></li>
          </ul>
        </div>
      </div>
    </nav>
    <div class="row kotak c">
    	<div class="col-sm-12 col-md-12">
    		<form action="<?php echo base_url()."index.php/mengaji/cari"; ?>" method="post" class="cari">
    	...
    	<?php
  		if(isset($wacara)){
  			foreach ($wacara->result() as $nwacara) {
  			 	...
  			 	<div class="row c">
    				<form action="<?php echo base_url()."index.php/mengaji/inputnilai"; ?>" method="post">
