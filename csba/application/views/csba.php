...
<body>
    ...
    <div style="min-height:250px;">
    	<img src=<?=DOMAIN."image/placeholder.jpg"?> class="img-thumbnail profil" style="width:200px;height:200px;position:absolute;top:140px;left:50px;">
    </div>
...
">
    ...
    <script>window.jQuery || document.write('<script src=<?=DOMAIN."js/vendor/jquery.min.js"?>><\/script>')</script>
